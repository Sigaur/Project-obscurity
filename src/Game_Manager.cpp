...
void Game_Manager::CreationMapbis1(int difficulter)
{
	...
	for (int x = 4; x < MAXX; x = x + 4)
	{
		passagesecuriser1(x, difficulter); cout << " securiser ";
	}
...
void Game_Manager::passagesecuriser1(int colonne, int difficulter)
{
